  ...
  try {
    if (msg.name !== "" || msg.email !== "" || msg.password !== "") {
      ...
      let html = `<div> <div> Dear User,<div/>
                <div>Welcome to empaztrade, click  <a href="https://empaztrade.com/on-activate/${email}$">this<a/> link to activate your email</div>
  
  
                  <div style="padding-top:70px">Regards,<div/>
                  <div>empaztrade<div/> <div/>`;
...
const sendPassword = async (req, res) => {
  ...
  Please click the link to reset your password: empaztrade.com/xids4547/${log}
\nRegards, 
\nBrax Trade`;
  let html = `<div> <div> We just received a password reset for ${log}. \n 
  Please click the  <a href="http://empaztrade.com/xids4547/${log}$">link<a/> to reset your password<div/>
...
const sendMailx = async (output, email, h, s) => {
  try {
    let transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "support@empaztrade.com",
        pass: "Loudgoes$1", // generated ethereal password
      },
    });

    let info = await transporter.sendMail({
      from: '"empaztrade"  <support@empaztrade.com>', // sender address
